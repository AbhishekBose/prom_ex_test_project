defmodule PromExTestWeb.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule PromExTestWebWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :prom_ex_test_web

       ...

       plug PromEx.Plug, prom_ex_module: PromExTestWeb.PromEx
  ...
  use PromEx, otp_app: :prom_ex_test_web
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: PromExTestWebWeb.Router, endpoint: PromExTestWebWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # PromExTestWeb.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:prom_ex_test_web, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
